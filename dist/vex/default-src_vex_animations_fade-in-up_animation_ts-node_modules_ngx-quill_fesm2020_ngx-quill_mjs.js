...
/* harmony export */ });
/* harmony import */ var _home_sohaibnadeem_experiments_MMI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
...
class QuillService {
  constructor(injector, config) {
    ...
    this.config = config;
    this.quill$ = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.defer)( /*#__PURE__*/(0,_home_sohaibnadeem_experiments_MMI_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _this$config$customOp, _this$config$customMo;
      ...
      (_this$config$customOp = _this.config.customOptions) === null || _this$config$customOp === void 0 ? void 0 : _this$config$customOp.forEach(customOption => {
      ...
      (_this$config$customMo = _this.config.customModules) === null || _this$config$customMo === void 0 ? void 0 : _this$config$customMo.forEach(({
        implementation,
        path
      }) => {
...
class QuillEditorBase {
    ...
    this.quillSubscription = this.service.getQuill().subscribe(Quill => {
      ...
      this.zone.runOutsideAngular(() => {
        ...
        if (this.linkPlaceholder) {
          var _this$quillEditor, _this$quillEditor$the, _tooltip$root;

          const tooltip = (_this$quillEditor = this.quillEditor) === null || _this$quillEditor === void 0 ? void 0 : (_this$quillEditor$the = _this$quillEditor.theme) === null || _this$quillEditor$the === void 0 ? void 0 : _this$quillEditor$the.tooltip;
          const input = tooltip === null || tooltip === void 0 ? void 0 : (_tooltip$root = tooltip.root) === null || _tooltip$root === void 0 ? void 0 : _tooltip$root.querySelector('input[data-link]');
  ...
  ngOnDestroy() {
    ...
    this.dispose();
    (_this$quillSubscripti = this.quillSubscription) === null || _this$quillSubscripti === void 0 ? void 0 : _this$quillSubscripti.unsubscribe();
    this.quillSubscription = null;
  }
...
class QuillViewComponent {
  ...
  ngOnDestroy() {
    ...
    (_this$quillSubscripti2 = this.quillSubscription) === null || _this$quillSubscripti2 === void 0 ? void 0 : _this$quillSubscripti2.unsubscribe();
    this.quillSubscription = null;
  }
